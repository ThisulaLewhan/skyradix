      ...
      `}} />
            ...
            <footer id="contact" className="bg-black border-t border-white/5 pt-24 pb-8 px-6">
                ...
                <div className="max-w-7xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className={`text-xl font-black tracking-tighter text-white ${montserrat.className}`}>VANGUARD</div>
                    <div className="flex items-center gap-6">
                        {["INSTAGRAM", "FACEBOOK", "YOUTUBE"].map((social, i) => (
                            <a key={i} href="#" className="font-bold text-xs tracking-widest text-[#B0B0B0] hover:text-[#AAFF00] transition-colors">
                                {social}
                            </a>
                        ))}
                    </div>
                    <p className="text-[#B0B0B0] text-xs">&copy; 2025 SKYRADIX. ALL RIGHTS RESERVED.</p>
                </div>
            </footer>
        </div>
    );
