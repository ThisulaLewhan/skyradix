...
const HeroSection = () => {
  return (
    <section className="relative h-[10vh] min-h-[400px] md:min-h-[400px] lg:min-h-[500px] w-full overflow-hidden bg-gradient-to-b from-[#f5f5f5] to-[#dfdaee]">
      {/* Background Wave */}
     ...
     {/* Main Content */}
      <div className="relative z-20 flex h-full flex-col items-center justify-center px-8 text-center">
        ...
        <p className={`${poppins500.className} mb-12 max-w-[580px] text-[clamp(12px,2.5vw,19px)] leading-relaxed text-black`}>
          Streamline your operations, enhance productivity and achieve scalability with tailored software
          <br />
          built just for you
        </p>
    ...
    <div className="absolute bottom-[clamp(1rem,1vw,6rem)] md:bottom-[clamp(5rem,1vw,6rem)] lg:bottom-[clamp(1rem,1vw,6rem)] left-[50%] md:left-[50%] lg:left-[50%] z-20 h-8 w-8 -translate-x-1/2 animate-bounce">
      <Image
